...
const AdminForm =()=> {  
    ...
    const handleSubmit=(e)=>{
        ...
        axios
            .post(`${url}/api/properties/add`, newProperty)
                ...
                <form  onSubmit={handleSubmit}>
                    <div className="flex-row flex-row-center">
                        ...
                        <div className="flex-col">
                            ...
                            <input type="text" name="propertyOneBedroomSqft"  className="admin-inputs" placeholder="One Bedroom Sqft" value={newPropData.propertyOneBedroomSqft} onChange={handleChange}></input>
                        </div>
                        <div className="flex-col">
                    ...
                    <button type="submit" className="btn-submit btn-primary">Add Property</button>
                </form>
